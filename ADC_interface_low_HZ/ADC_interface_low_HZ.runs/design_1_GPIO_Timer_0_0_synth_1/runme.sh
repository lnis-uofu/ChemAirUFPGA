...
HD_PWD='C:/Users/owenm/Programming/Verilog/ADC_interface_low_HZ/ADC_interface_low_HZ.runs/design_1_GPIO_Timer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_GPIO_Timer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_GPIO_Timer_0_0.tcl
