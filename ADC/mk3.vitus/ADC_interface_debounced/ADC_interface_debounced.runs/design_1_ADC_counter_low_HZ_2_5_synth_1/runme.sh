...
HD_PWD='C:/Users/owenm/Programming/Verilog/ADC_interface_debounced/ADC_interface_debounced.runs/design_1_ADC_counter_low_HZ_2_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_ADC_counter_low_HZ_2_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_ADC_counter_low_HZ_2_5.tcl
