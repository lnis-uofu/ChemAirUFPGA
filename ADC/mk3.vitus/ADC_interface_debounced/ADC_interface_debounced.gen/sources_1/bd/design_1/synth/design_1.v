...
module design_1
  ...
  wire [31:0]ADC_counter_low_HZ_0_count_out;
  wire ADC_counter_low_HZ_0_led_out;
  wire [31:0]ADC_counter_low_HZ_10_count_out;
  wire ADC_counter_low_HZ_10_led_out;
  wire [31:0]ADC_counter_low_HZ_11_count_out;
  wire ADC_counter_low_HZ_11_led_out;
  wire [31:0]ADC_counter_low_HZ_1_count_out;
  wire ADC_counter_low_HZ_1_led_out;
  wire [31:0]ADC_counter_low_HZ_2_count_out;
  wire ADC_counter_low_HZ_2_led_out;
  wire [31:0]ADC_counter_low_HZ_3_count_out;
  wire ADC_counter_low_HZ_3_led_out;
  wire [31:0]ADC_counter_low_HZ_4_count_out;
  wire ADC_counter_low_HZ_4_led_out;
  wire [31:0]ADC_counter_low_HZ_5_count_out;
  wire ADC_counter_low_HZ_5_led_out;
  wire [31:0]ADC_counter_low_HZ_6_count_out;
  wire ADC_counter_low_HZ_6_led_out;
  wire [31:0]ADC_counter_low_HZ_7_count_out;
  wire ADC_counter_low_HZ_7_led_out;
  wire [31:0]ADC_counter_low_HZ_8_count_out;
  wire ADC_counter_low_HZ_8_led_out;
  wire [31:0]ADC_counter_low_HZ_9_count_out;
  wire ADC_counter_low_HZ_9_led_out;
  wire GPIO_Timer_0_timer_flag;
  ...
  assign c_in_10_1 = c_in_10;
  assign c_in_11_1 = c_in_11;
  assign c_in_1_1 = c_in_1;
  assign c_in_2_1 = c_in_2;
  assign c_in_3_1 = c_in_3;
  assign c_in_4_1 = c_in_4;
  assign c_in_5_1 = c_in_5;
  assign c_in_6_1 = c_in_6;
  assign c_in_7_1 = c_in_7;
  assign c_in_8_1 = c_in_8;
  assign c_in_9_1 = c_in_9;
  assign led = GPIO_Timer_0_timer_flag;
  ...
  design_1_ADC_counter_low_HZ_0_0 ADC_counter_low_HZ_0
       (.clk_in(clk_wiz_0_clk_out2),
        .count_in(\^c_in_1 ),
        .count_out(ADC_counter_low_HZ_0_count_out),
        .led_out(ADC_counter_low_HZ_0_led_out));
  design_1_ADC_counter_low_HZ_1_0 ADC_counter_low_HZ_1
       (.clk_in(clk_wiz_0_clk_out2),
        .count_in(c_in_1_1),
        .count_out(ADC_counter_low_HZ_1_count_out),
        .led_out(ADC_counter_low_HZ_1_led_out));
  design_1_ADC_counter_low_HZ_2_8 ADC_counter_low_HZ_10
       (.clk_in(clk_wiz_0_clk_out2),
        .count_in(c_in_10_1),
        .count_out(ADC_counter_low_HZ_10_count_out),
        .led_out(ADC_counter_low_HZ_10_led_out));
  design_1_ADC_counter_low_HZ_2_9 ADC_counter_low_HZ_11
       (.clk_in(clk_wiz_0_clk_out2),
        .count_in(c_in_11_1),
        .count_out(ADC_counter_low_HZ_11_count_out),
        .led_out(ADC_counter_low_HZ_11_led_out));
  design_1_ADC_counter_low_HZ_2_0 ADC_counter_low_HZ_2
       (.clk_in(clk_wiz_0_clk_out2),
        .count_in(c_in_2_1),
        .count_out(ADC_counter_low_HZ_2_count_out),
        .led_out(ADC_counter_low_HZ_2_led_out));
  design_1_ADC_counter_low_HZ_2_1 ADC_counter_low_HZ_3
       (.clk_in(clk_wiz_0_clk_out2),
        .count_in(c_in_3_1),
        .count_out(ADC_counter_low_HZ_3_count_out),
        .led_out(ADC_counter_low_HZ_3_led_out));
  design_1_ADC_counter_low_HZ_2_2 ADC_counter_low_HZ_4
       (.clk_in(clk_wiz_0_clk_out2),
        .count_in(c_in_4_1),
        .count_out(ADC_counter_low_HZ_4_count_out),
        .led_out(ADC_counter_low_HZ_4_led_out));
  design_1_ADC_counter_low_HZ_2_3 ADC_counter_low_HZ_5
       (.clk_in(clk_wiz_0_clk_out2),
        .count_in(c_in_5_1),
        .count_out(ADC_counter_low_HZ_5_count_out),
        .led_out(ADC_counter_low_HZ_5_led_out));
  design_1_ADC_counter_low_HZ_2_4 ADC_counter_low_HZ_6
       (.clk_in(clk_wiz_0_clk_out2),
        .count_in(c_in_6_1),
        .count_out(ADC_counter_low_HZ_6_count_out),
        .led_out(ADC_counter_low_HZ_6_led_out));
  design_1_ADC_counter_low_HZ_2_5 ADC_counter_low_HZ_7
       (.clk_in(clk_wiz_0_clk_out2),
        .count_in(c_in_7_1),
        .count_out(ADC_counter_low_HZ_7_count_out),
        .led_out(ADC_counter_low_HZ_7_led_out));
  design_1_ADC_counter_low_HZ_2_6 ADC_counter_low_HZ_8
       (.clk_in(clk_wiz_0_clk_out2),
        .count_in(c_in_8_1),
        .count_out(ADC_counter_low_HZ_8_count_out),
        .led_out(ADC_counter_low_HZ_8_led_out));
  design_1_ADC_counter_low_HZ_2_7 ADC_counter_low_HZ_9
       (.clk_in(clk_wiz_0_clk_out2),
        .count_in(c_in_9_1),
        .count_out(ADC_counter_low_HZ_9_count_out),
        .led_out(ADC_counter_low_HZ_9_led_out));
  design_1_GPIO_Timer_0_0 GPIO_Timer_0
       (.set_time(axi_gpio_12_gpio_io_o),
        .time_clk(microblaze_0_Clk),
        .timer_flag(GPIO_Timer_0_timer_flag));
  design_1_axi_gpio_0_0 axi_gpio_0
       (.gpio2_io_i(ADC_counter_low_HZ_0_led_out),
        .gpio_io_i(ADC_counter_low_HZ_0_count_out),
  ...
  design_1_axi_gpio_1_0 axi_gpio_1
       (.gpio2_io_i(ADC_counter_low_HZ_1_led_out),
        .gpio_io_i(ADC_counter_low_HZ_1_count_out),
        .s_axi_aclk(microblaze_0_Clk),
  ...
  design_1_axi_gpio_2_8 axi_gpio_10
       (.gpio2_io_i(ADC_counter_low_HZ_10_led_out),
        .gpio_io_i(ADC_counter_low_HZ_10_count_out),
        .s_axi_aclk(microblaze_0_Clk),
  ...
  design_1_axi_gpio_2_9 axi_gpio_11
       (.gpio2_io_i(ADC_counter_low_HZ_11_led_out),
        .gpio_io_i(ADC_counter_low_HZ_11_count_out),
        .s_axi_aclk(microblaze_0_Clk),
  ...
  design_1_axi_gpio_2_0 axi_gpio_2
       (.gpio2_io_i(ADC_counter_low_HZ_2_led_out),
        .gpio_io_i(ADC_counter_low_HZ_2_count_out),
        .s_axi_aclk(microblaze_0_Clk),
  ...
  design_1_axi_gpio_2_1 axi_gpio_3
       (.gpio2_io_i(ADC_counter_low_HZ_3_led_out),
        .gpio_io_i(ADC_counter_low_HZ_3_count_out),
        .s_axi_aclk(microblaze_0_Clk),
  ...
  design_1_axi_gpio_2_2 axi_gpio_4
       (.gpio2_io_i(ADC_counter_low_HZ_4_led_out),
        .gpio_io_i(ADC_counter_low_HZ_4_count_out),
        .s_axi_aclk(microblaze_0_Clk),
  ...
  design_1_axi_gpio_2_3 axi_gpio_5
       (.gpio2_io_i(ADC_counter_low_HZ_5_led_out),
        .gpio_io_i(ADC_counter_low_HZ_5_count_out),
        .s_axi_aclk(microblaze_0_Clk),
  ...
  design_1_axi_gpio_2_4 axi_gpio_6
       (.gpio2_io_i(ADC_counter_low_HZ_6_led_out),
        .gpio_io_i(ADC_counter_low_HZ_6_count_out),
        .s_axi_aclk(microblaze_0_Clk),
  ...
  design_1_axi_gpio_2_5 axi_gpio_7
       (.gpio2_io_i(ADC_counter_low_HZ_7_led_out),
        .gpio_io_i(ADC_counter_low_HZ_7_count_out),
        .s_axi_aclk(microblaze_0_Clk),
  ...
  design_1_axi_gpio_2_6 axi_gpio_8
       (.gpio2_io_i(ADC_counter_low_HZ_8_led_out),
        .gpio_io_i(ADC_counter_low_HZ_8_count_out),
        .s_axi_aclk(microblaze_0_Clk),
  ...
  design_1_axi_gpio_2_7 axi_gpio_9
       (.gpio2_io_i(ADC_counter_low_HZ_9_led_out),
        .gpio_io_i(ADC_counter_low_HZ_9_count_out),
        .s_axi_aclk(microblaze_0_Clk),
  ...
  design_1_axi_gpio_12_0 axi_gpio_timer
       (.gpio2_io_i(GPIO_Timer_0_timer_flag),
  ...
  design_1_axi_quad_spi_0_0 axi_quad_spi_0
       (.ext_spi_clk(microblaze_0_Clk),
        ...
        .s_axi_aclk(microblaze_0_Clk),
        .s_axi_araddr(microblaze_0_axi_periph_M15_AXI_ARADDR[6:0]),
        .s_axi_aresetn(rst_clk_wiz_0_100M_peripheral_aresetn),
        .s_axi_arready(microblaze_0_axi_periph_M15_AXI_ARREADY),
        .s_axi_arvalid(microblaze_0_axi_periph_M15_AXI_ARVALID),
        .s_axi_awaddr(microblaze_0_axi_periph_M15_AXI_AWADDR[6:0]),
